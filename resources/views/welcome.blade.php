...
<body>
    <div class="container">
        <header>
            <nav>
                <div class="logo">
                    <img src="{{ asset('assets/Ryu.png') }}" alt="" width="150" weight="75" />
                </div>
        ...
        <main>
            <div class="jumbotron">
                <div class="jumbotron-text">
                    <h1>Ambilah Samartphomu Dan Nikmati Fiturtnya</h1>
                    <p> Lewati Hari-Harimu Dengan Smartphone Moderen</p>
                    <button type="button" class="btn_getStarted">Mulai</button>
                </div>
                <div class="jumbotron-img">
                    <img src="assets/Bahan.png" alt="" />
                </div>
            </div>
